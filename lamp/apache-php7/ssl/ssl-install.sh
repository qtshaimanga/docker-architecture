...
if [ -z "$DOMAINES" ]; then
	...
	/opt/letsencrypt/letsencrypt-auto --noninteractive --apache --standalone certonly --renew-by-default --preferred-challenges tls-sni --email q.tshaimanga@gmail.com --agree-tos --domaines quentintshaimanga.fr
